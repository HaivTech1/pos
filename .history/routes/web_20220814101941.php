...
Route::middleware([
    ...
    Route::group(['prefix' => 'cashier', 'as' => 'cashier.'], function () {
        ...
        Route::get('show/{user}', [CashierController::class, 'show'])->name('show');
        Route::get('edit/{user}', [CashierController::class, 'edit'])->name('edit');
        Route::get('create', [CashierController::class, 'create'])->name('create');
        Route::put('/{user}', [CashierController::class, 'update'])->name('update');
    });
});