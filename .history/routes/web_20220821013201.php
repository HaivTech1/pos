...
Route::middleware([
    ...
    Route::group(['prefix' => 'supplier', 'as' => 'supplier.'], function () {
        Route::get('/', [SupplierController::class, 'getOption'])->name('get');
        Route::get('/options/branch/get', [SupplierController::class, 'getBranchOption'])->name('branch.get');
        Route::post('/options/branch/put', [SupplierController::class, 'putBranchOption'])->name('branch.post');
    });
