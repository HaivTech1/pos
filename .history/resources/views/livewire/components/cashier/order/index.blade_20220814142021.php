                                ...
                                <div class="card-body">
                                    <div class="mb-3 btn-group">
                                        <button type="button" onclick="PrintReceiptContent('print')"
                                            class="mr-2 rounded btn btn-dark"><i class="fa fa-print"></i> Print
                                        </button>
                                        <button type="button" data-toggle="modal" data-target="#history"
                                            class="mr-2 rounded btn btn-primary"><i class="fa fa-print"></i> History
                                        </button>
                                        <a href="{{ url('/pdfview') }}" class="rounded btn btn-danger"><i
                                                class="fa fa-print"></i> Generate Daily Report </a>
                                    </div>
