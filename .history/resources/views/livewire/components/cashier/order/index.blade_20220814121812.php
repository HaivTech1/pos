                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="my-2">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <x-form.input type='text' placeholder="Search..."
                                            ...
                                            <table class="table align-middle table-nowrap table-check">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="30%">
                                                            <input type="text"
                                                                class="form-control text-red-600 font-medium"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                                <div class="" data-aos="fade-up">
                                                    ...
                                                    <button
                                                        wire:click.prevent="InsertManualToCart({{ $product->id() }})">
                                                        <div class="">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text"> {{ application('symbol') }} {{
