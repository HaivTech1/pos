                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-sm-6">
                                            <x-form.input type='text' placeholder="Customer Name"
                                                wire:model.defer="state.c_name" />
                                        </div>
                                        <div class="col-sm-6">
                                            <x-form.input type='text' placeholder="Customer Number"
                                                wire:model.defer="state.c_number" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-sm-12">
                                            ...
                                            <x-form.input type='text' wire:model.defer="state.c_name" />
                                        </div>
                                        <div class="col-sm-12">
                                            <x-form.label for="title" value="{{ __('Remaining Change') }}" />

                                            <x-form.input type='text' wire:model.defer="state.c_number" />
                                        </div>
                                    </div>
                                </div>
                            </div>
