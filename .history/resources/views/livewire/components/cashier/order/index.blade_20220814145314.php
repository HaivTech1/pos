                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="formCheck1"
                                                        wire:model.defer="cash" value='cash'>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="formCheck2"
                                                        wire:model.defer="transfer" value='transfer'>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-check mb-3">
                                                    <input class="form-check-input" type="checkbox" id="formCheck3"
                                                        wire:model.defer="card" value='card'>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-sm-12">
                                            ...
                                            <x-form.input type='text' wire:model.debounce.500ms="pay_money" />
                                        </div>
                                        <div class="col-sm-12">
                                            <x-form.label for="title" value="{{ __('Remaining Change') }}" />

                                            <x-form.input type='text' wire:model.defer="balance" disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
