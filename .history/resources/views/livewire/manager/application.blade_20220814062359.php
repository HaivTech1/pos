        ...
        <x-slot name="form">
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select id="my-select" class="text-red-600 custom-select" wire:model.defer="app.currency">
                        @foreach ($countries as $id => $country)
                        <option value="{{ $id }}" {{ ($setting->currency ? $setting->country->id : old('currency')) ==
                            $id ? 'selected' : '' }}>{{ $country }}</option>
                        @endforeach
                    </select>
