        ...
        <x-slot name="form">
            <div class="row">
                ...
                <div class="d-flex justify-content-center align-items-center mt-3">
                    ...
                    <input type="checkbox" id="switch1" switch="none" checked value="1" name="cashier_setting" />
                    <label for="switch1" data-on-label="On" data-off-label="Off"></label>
                    <span class="text-bold font-semibold text-primary uppercase">Cashier
                        Settings</span>
                ...
                <div class="d-flex justify-content-center align-items-center mt-3">
                    ...
                    <input type="checkbox" id="switch1" switch="none" checked value="1" name="product_preview" />
                    <label for="switch1" data-on-label="On" data-off-label="Off"></label>
