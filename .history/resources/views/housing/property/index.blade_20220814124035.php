                            ...
                            <tr>
                                    ...
                                    <div class="avatar-group">
                                        ...
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block">
                                                <img src="{{ asset('storage/properties/'.$image[$index]) }}" alt=""
                                ...
                                <td>
                                    <h5 class="text-truncate font-size-14"><a href="javascript: void(0);"
                                            class="text-dark">{{ $property->title() }}</a></h5>
                                ...
                                <td>
                                    <livewire:components.general-action :model="$property" :wire:key="$property->id()">
                                        <a class="dropdown-item" href="{{ route('property.show', $property) }}"><i
                                                class="fa fa-eye"></i></a>
                                        <a class="dropdown-item" href="{{ route('property.edit', $property) }}"><i
