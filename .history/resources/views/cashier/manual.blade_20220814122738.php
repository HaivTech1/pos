<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 d-flex align-items-stretch" wire:key="$product=>id()">
            <div class="" data-aos="fade-up">
                ...
                <div wire:click="InsertManualToCart({{ $product->id() }})" style="cursor: pointer">
                    <div class="">
                        <img width="150" height="150" src="{{ asset('storage/products/'.$product->image()[0])}}"
