<div class="card-body">
    ...
    <div class="my-2">
        <div class="row">
            ...
            <div class="col-md-6">
                <x-form.input type='text' placeholder="Search..." wire:model.debounce.500ms="search" autofocus />
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" class="form-control total_amount text-red-600 font-medium"
                            value="{{ $cart->qty() * $cart->product->price() }}" disabled>
                    </td>
                    <td>
        ...
        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="">
                ...
                <div wire:click="InsertToCart({{ $product }})" style="cursor: pointer">
                    <div>
                        <img width="70" height="70" src="{{ asset('storage/products/'.$product->image()[0])}}"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            {{ application('symbol') }} {{ number_format($product->price(),
