        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('brand.index') }}" key="t-add-product">Email</a></li>
                        <li><a href="{{ route('brand.index') }}" key="t-add-product">Bulk SMS</a></li>
                        <li><a href="{{ route('brand.index') }}" key="t-add-product">Communicator</a></li>
                    </ul>
                </li>
                @endmanager
                @staff
