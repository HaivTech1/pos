...
<script>
    //print section
        function PrintReceiptContent(el){
            var data = '<input type="button" id="printPageButton class="printPageButton d-print-none" style="display: block; width: 100%; border:none; background-color: #008B24; color: #fff; padding: 7px 14px; font-size: 16px; cursor:pointer; text-align: center" value="Receipt" onClick="window.print()">';
