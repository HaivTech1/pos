...
class Entry extends Model
{
    ...
    {
        return $this->time_start->format(config('panel.date_format') . ' ' . config('panel.time_format'));
    }

    public function timeEnd(): string
    {
        return $this->time_end->format(config('panel.date_format') . ' ' . config('panel.time_format'));
    }
